...
onMounted(async () => {
  ...
  totalA2P = await obtenerDatosVariable(clienteID, 49);
  totalA3P = await obtenerDatosVariable(clienteID, 50);
  totalB1 = await obtenerDatosVariable(clienteID, 51);
  totalB2 = await obtenerDatosVariable(clienteID, 52);
  totalB3 = await obtenerDatosVariable(clienteID, 53);
  totalB4 = await obtenerDatosVariable(clienteID, 54);
  totalB5 = await obtenerDatosVariable(clienteID, 55);
  totalKilos = await obtenerDatosVariable(clienteID, 48);
  horasMarcha = await obtenerDatosVariable(clienteID, 48);
  unidades.value = [
  ...
  consumos.value = [
    ...
    { id: 1, name: totalA3P.registros[3][0].total },
    { id: 2, name: totalB1.registros[3][0].total },
    { id: 3, name: totalB2.registros[3][0].total },
    { id: 4, name: totalB3.registros[3][0].total },
    { id: 5, name: totalB4.registros[3][0].total },
    { id: 6, name: totalB5.registros[3][0].total },
    { id: 7, name: totalKilos.registros[3][0].total },
    { id: 8, name: horasMarcha.registros[3][0].total },
  ];
  cargado.value = true;
});
</script>
