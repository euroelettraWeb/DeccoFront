...
onMounted(async () => {
  ...
  kgPCaja = await obtenerDatosVariable("8h", "registros", "formatoLinea", 67);
  tCajas = await obtenerDatosVariable("8h", "registros", "formatoLinea", 68);
  tKg = await obtenerDatosVariable("8h", "registros", "formatoLinea", 69);
